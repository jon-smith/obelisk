...
SimpleAsyncTask::SimpleAsyncTask() : impl(std::make_unique<Impl>()) {}

SimpleAsyncTask::SimpleAsyncTask(std::function<void(void)> &&fn) : impl(std::make_unique<Impl>(*this, [fn = std::move(fn)] { fn(); })) {}

SimpleAsyncTask::SimpleAsyncTask(const SimpleAsyncTask &o) : impl(std::make_unique<Impl>(o.impl->future)) {}

SimpleAsyncTask::SimpleAsyncTask(SimpleAsyncTask &&o) : impl(std::unique_ptr<Impl>(o.impl.release())) {}
