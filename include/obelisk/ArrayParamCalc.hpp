...
template <typename IteratorT, size_t nPercentiles>
auto calculateApproximatePercentiles(const IteratorT dataBegin, const IteratorT dataEnd, const std::array<double, nPercentiles> &percentilesToCalculate)
