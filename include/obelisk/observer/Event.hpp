...
template <typename... Args> class Event : public EventBase
{
  ...
  public:
	...
	Event(SubjectWithEvents &owner, std::wstring name) : EventBase(name), owner(owner) { owner.addOwnedEvent(*this); }
